...
class DeepSludgePump : RebarBlock, DirectionalRebarBlock, SimpleRebarMultiblock, ProcessorRebarBlock,
    TickingRebarBlock {
    ...
    override fun onMultiblockFormed() {
        ...
        getMultiblockComponentOrThrow(FluidInputHatch::class.java, DIESEL_INPUT_HATCH).setFluidType(PylonFluids.BIODIESEL)
        getMultiblockComponentOrThrow(FluidOutputHatch::class.java, DEEP_SLUDGE_OUTPUT).setFluidType(GantryFluids.DEEP_SLUDGE)
    }
